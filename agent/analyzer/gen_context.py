...
_GENERATED_MARKER = "# Generated by CheckExploit gen_context (safe to delete)."
    ...
    for _prio, rel in files:
        ...
        try:
            with open(path, encoding="utf-8", errors="replace") as fh:
                head = fh.readline()
                if head.startswith("# Generated by CheckExploit"):
    ...
    for root, dirs, names in os.walk(repo_path):
        ...
        for fname in names:
            if fname == "Dockerfile" or fname.startswith("Dockerfile."):
                ...
                if lines and lines[0].startswith("# Generated by CheckExploit"):
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="CheckExploit build-context generator")
